...
每天北京时间 07:00，GitHub Actions 会生成中文行业日报，并同时保留两种查看方式：

- GitHub 仓库：`老板行业日报/YYYY/MM/YYYY-MM-DD.md`
- GitHub Pages：继续使用现有 Horizon 日报网站
...
脚本只会把公开 GitHub 仓库中的 `老板行业日报` 复制到 `D:\Obsidian\老板行业日报`，不会删除目标文件夹中的其他文件。
